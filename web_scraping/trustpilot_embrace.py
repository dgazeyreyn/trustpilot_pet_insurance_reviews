...
url = "https://www.trustpilot.com/review/embracepetinsurance.com"
...
while True:
    if page <= last_page:
        url = f"https://www.trustpilot.com/review/embracepetinsurance.com?page={page}"
        urls.append(url)
        page = page + 1
    else:
        break
...
final_df.to_csv('embrace_reviews.csv', index=False)
