...
url = "https://www.trustpilot.com/review/www.pumpkin.care"
...
while True:
    if page <= last_page:
        url = f"https://www.trustpilot.com/review/www.pumpkin.care?page={page}"
        urls.append(url)
        page = page + 1
    else:
        break
...
final_df.to_csv('pumpkin_reviews.csv', index=False)
