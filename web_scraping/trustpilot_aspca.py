...
url = "https://www.trustpilot.com/review/aspcapetinsurance.com"
...
while True:
    if page <= last_page:
        url = f"https://www.trustpilot.com/review/aspcapetinsurance.com?page={page}"
        urls.append(url)
        page = page + 1
    else:
        break
...
final_df.to_csv('aspca_reviews.csv', index=False)
