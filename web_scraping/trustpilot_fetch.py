...
url = "https://www.trustpilot.com/review/fetchpet.com"
...
while True:
    if page <= last_page:
        url = f"https://www.trustpilot.com/review/fetchpet.com?page={page}"
        urls.append(url)
        page = page + 1
    else:
        break
...
final_df.to_csv('fetch_reviews.csv', index=False)
