...
url = "https://www.trustpilot.com/review/www.akcpetinsurance.com"
...
while True:
    if page <= last_page:
        url = f"https://www.trustpilot.com/review/www.akcpetinsurance.com?page={page}"
        urls.append(url)
        page = page + 1
    else:
        break
...
final_df.to_csv('akc_reviews.csv', index=False)
