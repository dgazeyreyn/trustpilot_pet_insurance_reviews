...
url = "https://www.trustpilot.com/review/figopetinsurance.com"
...
while True:
    if page <= last_page:
        url = f"https://www.trustpilot.com/review/figopetinsurance.com?page={page}"
        urls.append(url)
        page = page + 1
    else:
        break
...
final_df.to_csv('figo_reviews.csv', index=False)